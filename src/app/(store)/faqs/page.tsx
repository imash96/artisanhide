                ...
                <div>
                    {FAQS.map((faq, index) => (
                        <div key={index} className="text-white border-b border-mildGold">
                            {/* Question */}
                            <button
                                className={`w-full BricolageGrotesqueFont flex cursor-pointer  justify-between items-center px-4 py-6 text-left tracking-wide text-[#242424] hover:bg-gray-50 focus:outline-none ${openItem === faq.question ? "" : ""
                                    }`}
