...
import CustomButton from "@module/common/custom-button";
import Container from "@module/common/create-section";
import { addToCart } from "@lib/action/cart";
import { addToWishlist, deleteItemWishlist } from "@lib/action/wishlist";
                ...
                <form action={formActionCart} className="flex flex-col gap-4 w-full">
                    <div className="flex gap-2">
                        <CustomButton
                            ...
                            className="shrink-0"
                        >
                            {isPendingCart && <LoaderCircle className="w-4 h-4" />} Add to Cart
                        </CustomButton>
                    </div>
                </form>
