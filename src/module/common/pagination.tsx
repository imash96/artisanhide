        ...
        <>
            {totalPages > 1 && (
                <nav className="flex items-center justify-center md:justify-end mt-8 gap-2 flex-wrap border-t-2 pt-4" aria-label="Pagination">
                    {/* Prev */}
                    <Link
                        href={`${href}?page=${currentPage - 1 <= 0 ? 1 : currentPage - 1}` as Route}
                    ...
                    {/* Next */}
                    <Link
                        href={`${href}?page=${currentPage + 1 > totalPages ? totalPages : currentPage + 1}` as Route}
