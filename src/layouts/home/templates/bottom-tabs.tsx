...
export default function BottomTabs() {
  ...
  return (
    <div className="lg:hidden select-none h-[65px] bg-white border-t rounded-t-2xl grid grid-cols-5 fixed w-full bottom-0 z-10 left-0 my-auto text-brown">
      <LocalizedClientLink href={"/"} className="grid gap-1 active:bg-gray-200 place-content-center place-items-center">
      ...
      <LocalizedClientLink href={"/category/"} className=" grid gap-1 active:bg-gray-200 place-content-center place-items-center">
      ...
      <LocalizedClientLink href={`/account`} className="grid gap-1 active:bg-gray-200 place-content-center place-items-center">
