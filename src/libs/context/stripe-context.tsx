...
export default function StripeProvider({ paymentSession, stripeKey, stripePromise, children }: StripeContextProps) {
    ...
    if (!paymentSession.data.client_secret) throw new Error("Stripe client secret is missing. Cannot initialize Stripe.")
